...
#TODO-pl profile code and do performance testing
...
#DONE 09-23-2017 TODO-pl fix flush overage code
...
def best_13card_hand(card_list2):
    ...
    # evaluates up to 53 hands, if more than 53, I need to extend hand3, hand2, hand1
    hand3 = [[], [], [], [], [], [], [], [], [], [], [], [], [], [],
             [], [], [], [], [], [], [], [], [], [], [], [], [],
             [], [], [], [], [], [], [], [], [], [], [], [], [],
             [], [], [], [], [], [], [], [], [], [], [], [], []]
...
def best_hand3(card_list2):
    ...
    for i in range(4):  # flush
        if suit_rank_array[i][15] >= 5:
            if suit_rank_array[i][15] == 5: # 5 card flush adds 1 hand
                for card in card_list2:
                    if suits[i] in card:
                        hand3[hand_num].append(card)
                    score_array[3][hand_num] = score(hand3[hand_num], "3")
                    hand_num += 1
            elif suit_rank_array[i][15] == 6: # 6 card flush adds 6 hands
                for card in card_list2:
                    if suits[i] in card:
                        hand3[hand_num+0].append(card)
                        hand3[hand_num+1].append(card)
                        hand3[hand_num+2].append(card)
                        hand3[hand_num+3].append(card)
                        hand3[hand_num+4].append(card)
                        hand3[hand_num+5].append(card)
                delete hand3[hand_num + 0][0]
                delete hand3[hand_num + 1][1]
                delete hand3[hand_num + 2][2]
                delete hand3[hand_num + 3][3]
                delete hand3[hand_num + 4][4]
                delete hand3[hand_num + 5][5]
                hand3[hand_num + 2].append(card)
                hand3[hand_num + 3].append(card)
                hand3[hand_num + 4].append(card)
                hand3[hand_num + 5].append(card)
                hand_num = hand_num + 6
            elif suit_rank_array[i][15] == 7: # 7 card flush adds 21 hands (7*6/2)
                for card in card_list2:
                    if suits[i] in card:
                        hand3[hand_num+0].append(card)
                        hand3[hand_num+1].append(card)
                        ...
                        hand3[hand_num+4].append(card)
                        hand3[hand_num+5].append(card)
                        hand3[hand_num+6].append(card)
                        hand3[hand_num+7].append(card)
                        hand3[hand_num+8].append(card)
                        hand3[hand_num+9].append(card)
                        hand3[hand_num+10].append(card)
                        hand3[hand_num+11].append(card)
                        hand3[hand_num+12].append(card)
                        hand3[hand_num+13].append(card)
                        hand3[hand_num+14].append(card)
                        hand3[hand_num+15].append(card)
                        hand3[hand_num+16].append(card)
                        hand3[hand_num+17].append(card)
                        hand3[hand_num+18].append(card)
                        hand3[hand_num+19].append(card)
                        hand3[hand_num+20].append(card)
                        hand3[hand_num+21].append(card)
                delete hand3[hand_num + 0][6]
                delete hand3[hand_num + 0][5]
                delete hand3[hand_num + 1][6]
                delete hand3[hand_num + 1][4]
                delete hand3[hand_num + 2][6]
                delete hand3[hand_num + 2][3]
                delete hand3[hand_num + 3][6]
                delete hand3[hand_num + 3][2]
                delete hand3[hand_num + 4][6]
                delete hand3[hand_num + 4][1]
                delete hand3[hand_num + 5][6]
                delete hand3[hand_num + 5][0]
                delete hand3[hand_num + 6][6]
                delete hand3[hand_num + 6][4]
                delete hand3[hand_num + 7][6]
                delete hand3[hand_num + 7][3]
                delete hand3[hand_num + 8][6]
                delete hand3[hand_num + 8][2]
                delete hand3[hand_num + 9][6]
                delete hand3[hand_num + 9][1]
                delete hand3[hand_num + 10][6]
                delete hand3[hand_num + 10][0]
                delete hand3[hand_num + 11][6]
                delete hand3[hand_num + 11][3]
                delete hand3[hand_num + 12][6]
                delete hand3[hand_num + 12][2]
                delete hand3[hand_num + 13][6]
                delete hand3[hand_num + 13][1]
                delete hand3[hand_num + 14][6]
                delete hand3[hand_num + 14][0]
                delete hand3[hand_num + 15][6]
                delete hand3[hand_num + 15][2]
                delete hand3[hand_num + 16][6]
                delete hand3[hand_num + 16][1]
                delete hand3[hand_num + 17][6]
                delete hand3[hand_num + 17][0]
                delete hand3[hand_num + 18][5]
                delete hand3[hand_num + 18][4]
                delete hand3[hand_num + 19][5]
                delete hand3[hand_num + 19][3]
                delete hand3[hand_num + 20][5]
                delete hand3[hand_num + 20][2]
                delete hand3[hand_num + 21][5]
                delete hand3[hand_num + 21][1]
                hand_num = hand_num + 21
...
def best_hand2(card_listx, score_prob):
    ...
    if len(fiveks_list) > 0 and previous_hand_score >= 110000:
        ...
        for i in range(6,10):
            for j in range(2,11):
                if suit_rank_array[i][j] >= 1:
                    straightflush_score = 90000 + (j+4)*100 + j + 3
...
def score(card_listx, hand):
    ...
    # need to add straight flush
        ...
        score += ranks.index(suit_rank_array[straightflushsuit+9][1])
...
def score_final(card_listx, hand):   
    ...
    if len(fiveks_list) > 0:
        ...
        logging.info(("SF", straightflushes))
        score = 90000
        score += ranks.index(suit_rank_array[straightflushsuit+9][0]) * 100
        score += ranks.index(suit_rank_array[straightflushsuit + 9][1])
        ...
        for i in range(4):     #logging.info(( "flush", card_id
           if suit_rank_array[i][15] >= 5:
               logging.info(("flush", card_id))
               score = 60000
               score += ranks.index(suit_rank_array[15+i][0]) * 100 + ranks.index(suit_rank_array[15+i][1])        
        ...
        score = 40000
        logging.info(("trips", trips_list))
        score += ranks.index(trips_list[0]) * 100
        if len(sorted_card_listx) == 5:
        ...
        if len(singles_list) > 0:
            score += ranks.index(singles_list[0])
        logging.info(( "1 pair", pairs_list[0]))

    else:
        logging.info(( "nothing found - high/2nd high cards", sorted_card_listx))
        score = 10000
        if len(sorted_card_listx) > 0:
            score += ranks.index(sorted_card_listx[0][1]) * 100
            if len(sorted_card_listx) > 1:
                score += ranks.index(sorted_card_listx[1][1])
            logging.info(("singles only", sorted_card_listx, score))
    ...
    if hand == "3":
        ...
        if score >= 40000:
            prob = prob * 3
    prob = round(prob,2)
    logging.info(( "score", sorted_card_listx, score))
    return ([score, prob])
